...
ax2.scatter([], [], c = "k", marker = "o", label = "all particles")
ax2.scatter(taus, rmse_cut, marker = "o", facecolors='none', edgecolors = 'C3')
ax2.scatter([], [], marker = "o", facecolors='none', edgecolors = 'k', label = "in shadow")
ax2.plot([1e-8, 1e4],[1e-8/10, 1e4/10], c = 'C3', ls = ':') 
ax2.plot([1e-9, 1e4],[1e-9, 1e4], c = 'C3') 
ax1.set_xlabel(r"$\tau_{\rm refine}$")
ax1.set_xscale('log')
ax1.set_xlim(1e-9,1e4)
ax2.set_ylabel(r"${\rm RMS}\left[\left(F_{\tau_{\rm ref}} - F_{10^{-8}}\right)/F_{10^{-8}}\right]$", color = 'C3', labelpad=10)
