...
the tree cell, $r$ is distance to the closest cell edge 
...
If a group of sources occupies the biggest tree cell that meets this criteria, all 
...
\begin{equation}
\label{eqn:nsint}
N_{\rm cell} = \int_{R_0}^R \frac{4\pi r^2}{V_{\rm cell}(r)} dr
\end{equation}
...
\begin{equation}
\label{eqn:nssoln}
N_{\rm cell} = \int_{\sqrt[3]{N_B/N}}^R  \frac{4\pi r^2}{\tO^3} dr
\sim \log{N/N_B}.
\end{equation}
